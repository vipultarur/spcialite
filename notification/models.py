...
class Notification(models.Model):
    NOTIFICATION_TYPES = (
        ...
        (2, 'Comment'),
        (3, 'Follow'),
        (4, 'Reel Like'),  # Add Reel Like notification type
    )

    post = models.ForeignKey("post.Post", on_delete=models.CASCADE, related_name="notification_post", null=True, blank=True)
    reel = models.ForeignKey("post.Reel", on_delete=models.CASCADE, related_name="notification_reel", null=True, blank=True)  # Add reel field
